...
Expcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Expcoin Core, where everyone uses
...
pay attention to for reviewers of Expcoin Core code.

General Expcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Expcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
