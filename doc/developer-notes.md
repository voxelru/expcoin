...
Crowdcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Crowdcoin Core, where everyone uses
...
pay attention to for reviewers of Crowdcoin Core code.

General Crowdcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Crowdcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
