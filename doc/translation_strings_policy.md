...
This document provides guidelines for internationalization of the Expcoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Expcoin network</numerusform>
            <numerusform>%n active connections to Expcoin network</numerusform>
        </translation>
    </message>
