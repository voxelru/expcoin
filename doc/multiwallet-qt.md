...
Only requiring some minor changes is crowdcoin.cpp.
...
Changes to crowdcoin.cpp
----------------------
crowdcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
