...
Only requiring some minor changes is expcoin.cpp.
...
Changes to expcoin.cpp
----------------------
expcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
