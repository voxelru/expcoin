...
This mechanism has been integrated into Bitcore-Node-Expcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/expcoincoin/insight-api-expcoin#web-socket-api](https://github.com/expcoincoin/insight-api-expcoin#web-socket-api) 
* API: [https://github.com/expcoincoin/insight-api-expcoin#instantsend-transactions](https://github.com/expcoincoin/insight-api-expcoin#instantsend-transactions) 
...
By default, the Expcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Expcoin Core daemon:
