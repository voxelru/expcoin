...
This mechanism has been integrated into Bitcore-Node-Crowdcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/crowdcoincoin/insight-api-crowdcoin#web-socket-api](https://github.com/crowdcoincoin/insight-api-crowdcoin#web-socket-api) 
* API: [https://github.com/crowdcoincoin/insight-api-crowdcoin#instantsend-transactions](https://github.com/crowdcoincoin/insight-api-crowdcoin#instantsend-transactions) 
...
By default, the Crowdcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Crowdcoin Core daemon:
