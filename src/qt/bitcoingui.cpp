    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Crowdcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Crowdcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and crowdcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Crowdcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Crowdcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Crowdcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Crowdcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Crowdcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a crowdcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Crowdcoin Core help message to get a list with possible Crowdcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Crowdcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Crowdcoin network", "", count));
}
...
{
    QString strTitle = tr("Crowdcoin Core"); // default title
    ...
    // Append title to "Crowdcoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
