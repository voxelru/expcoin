    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Expcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Expcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and expcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Expcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Expcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Expcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Expcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Expcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a expcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Expcoin Core help message to get a list with possible Expcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Expcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Expcoin network", "", count));
}
...
{
    QString strTitle = tr("Expcoin Core"); // default title
