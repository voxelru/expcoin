    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Expcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Expcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  expcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Expcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://expcoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://expcoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Expcoin Core is shutting down...") + "<br /><br />" +
