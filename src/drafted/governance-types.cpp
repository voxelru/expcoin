...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ExpcoinNetwork") type = ExpcoinNetwork;
    if(strType == "ExpcoinNetworkVariable") type = ExpcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ExpcoinNetwork) s = "ExpcoinNetwork";
    if(type == ExpcoinNetworkVariable) s = "ExpcoinNetworkVariable";
