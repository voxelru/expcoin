...
{
    if(fLiteMode) return; // ignore all Expcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Expcoin and make it unusable. To
...
{
    if(fLiteMode) return; // disable all Expcoin specific functionality
    ...
    RenameThread("expcoin-privatesend");
