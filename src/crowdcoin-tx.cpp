...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Crowdcoin Core crowdcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  crowdcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded crowdcoin transaction") + "\n" +
              "  crowdcoin-tx [options] -create [commands]   " + _("Create hex-encoded crowdcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded crowdcoin transaction
